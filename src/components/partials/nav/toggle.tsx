                            ...
                            <Dialog.Panel className="relative transform overflow-hidden rounded-lg dark:bg-primary bg-tertiary shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                ...
                                <div className='flex flex-col gap-5 pb-5 px-4 w-[300px]'>
                                    ...
                                    <div className='flex mx-auto flex-col w-[150px] gap-y-2'>
                                        <span onClick={() => update_language('en')} className={`py-[2px] border-x-[15px] rounded-full ${(language !== "es") ? 'text-secondary border-secondary' : 'text-primary dark:text-tertiary border-transparent'} `}>
                                            {
                                                translate('toggle.lenguaje.l_1')
                                            }
                                        </span>
                                        <span onClick={() => update_language('es')} className={`py-[2px] border-x-[15px] rounded-full ${(language !== "en") ? 'text-secondary border-secondary' : 'text-primary dark:text-tertiary border-transparent'} `}>
                                            {
