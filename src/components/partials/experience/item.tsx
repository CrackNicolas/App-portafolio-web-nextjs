...
export default function ComponentItem(props: Props) {
    const { number, view_datails, setView_datails } = props;
    ...
    return (
        <div className="relative grid xl:grid-cols-5 gap-x-[40px] gap-y-[10px] sm:gap-y-[15px]">
            <span className={`text-primary dark:text-tertiary transition duration-500 xl:col-span-1 text-end tracking-wider my-auto font-semibold text-[15px]`}>
                {translate(`experience.data.item_${number}.title`)}
            </span>
            <div className={` transition duration-500 xl:col-span-4 xl:border-l-[3px] border-secondary xl:pt-[20px] xl:pr-[5px] xl:pb-[10px] xl:pl-[50px]`}>
