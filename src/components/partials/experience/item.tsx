...
export default function ComponentItem(props: Props) {
    ...
    return (
        <div className="relative grid xl:grid-cols-5 gap-x-[40px] gap-y-[10px] sm:gap-y-[15px]">
            <span className={`${animate && 'animate-[presentationLeft_1.2s_ease-in-out]'} xl:col-span-1 text-end tracking-wider my-auto font-semibold text-[15px]`}>
                {t(`experience.data.item_${number}.title`)}
            </span>
            <div className="xl:col-span-4 xl:border-l-[3px] border-text-secondary xl:pt-[20px] xl:pr-[5px] xl:pb-[10px] xl:pl-[50px]">
