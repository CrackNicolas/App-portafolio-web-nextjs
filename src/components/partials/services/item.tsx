...
export default function ComponentItem(props: Props) {
    ...
    return (
        <div className="group transition duration-500 p-[10px] sm:p-[20px] col-span-full lg:col-span-1 rounded-md border-[0.1px] border-text-secondary cursor-pointer hover:shadow-3xl hover:shadow-text-primary">
            <div className="bg-gradient-to-r from-bg-secondary to-text-secondary group-hover:from-text-secondary group-hover:to-bg-secondary w-[80px] h-[80px] sm:w-[90px] sm:h-[90px] grid place-items-center mx-auto mb-[10px] sm:mb-[15px] transition duration-700 text-bg-primary rounded-tr-[50%] rounded-bl-[50%] border-[1px] border-text-secondary">
